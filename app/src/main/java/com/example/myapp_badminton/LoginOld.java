...
//
//public class LoginOld extends AppCompatActivity implements AsyncResponse {
...
//        Intent intent = new Intent(LoginOld.this, MainActivity.class);
...
//        if (new HomePage().isConnected()) {new WebService(this).execute(API.ServerAddress + API.USER_LOGIN, "mail_id=" + Username + "&etPassword=" + Password);
////        if (new HomePage().isConnected()) {new WebService(this).execute(API.ServerAddress + "player_details.php", "academy_id=2&level=1&coach_id=22");
////        if (new HomePage().isConnected()) {new WebService(this).execute(API.ServerAddress + "get_academy.php", "module=coach&coach_id=22");
//
//    }
//
//
//    public void sendData(String value) {
//        Intent intent = new Intent(LoginOld.this, SearchActivity.class).putExtra("x", value).putExtra("P", "fromLogin");
//        startActivity(intent);
//    }
//
//    private void reset_password() {
//        Intent intent = new Intent(LoginOld.this, Reset_pass.class);
//        startActivity(intent);
//    }
//
//
...
////                        if (new HomePage().isConnected()) {new WebService(this).execute(API.ServerAddress + "" + API.USER_LOGIN, UserName,UserPassword);
//
...
//        List academy_name=new ArrayList();
//
//        academyResponse = result.split(";");
//        for (int i = 0; i < academyResponse.length; i++) {
//            LocationInfo(academyResponse[i],cities,academy_name);
//        }
...
////            indData=sData[i].split(",");
//            singleData.add(sData[i].split(","));
//
////            singleData.add(data.get(i).split(","));
//        }
////        for (int i=3;i<singleData.size();)
//int j=3;
//            while(singleData.size()>0)
//            {
//                System.out.println("the cities "+singleData.get(j));
//                j=j+7;
//
//            }
//
//            //        for (int i = 3; i < singleData.size(); i += 3) {
////            System.out.println("ind data"+singleData.get(i));
////        }
//
//        System.out.println("ind data "+Arrays.asList(indData));
//        System.out.println(Collections.singletonList(singleData));*/
//
//
//
//
...
//    }
//
//    private void LocationInfo(String s, List cities, List academy_name) {
