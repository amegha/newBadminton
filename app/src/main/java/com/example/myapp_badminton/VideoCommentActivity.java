...
import com.example.myapp_badminton.PlayModule.AnswersModel;
import com.example.myapp_badminton.PlayModule.CustomAdapter;
import com.example.myapp_badminton.PlayModule.DBHandler;
import com.example.myapp_badminton.PlayModule.GetAnswers;
import com.example.myapp_badminton.PlayModule.GetAnswersImpl1;
import com.example.myapp_badminton.PlayModule.SubmitAnswer;
import com.example.myapp_badminton.PlayModule.ViewAnswers;
import com.example.myapp_badminton.PlayModule.WebService;
...
//                            myPlayBackParams.setSpeed(0.2f); //you can set speed here
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
                                ...
                                mp.seekTo(initPos);
                            mp.start();
                            Log.e("connect and stream ", "link " + link);
